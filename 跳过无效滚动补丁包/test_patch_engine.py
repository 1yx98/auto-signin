...
P1B_DEF = os.path.join(HERE, "patches", "P2b.json")
...
if _ok7:
    print(f"        最终 sha256 = {_final_sha[:16]}...  （正常安装后应为 ed1f161e500fc2a7...）")
    _ok7 = _final_sha.startswith("ed1f161e500fc2a7")
    if not _ok7:
...
#   1) apply 本包（P2a+P2b）→ 文件 = ed1f161e…
E.apply_patch(json.loads(E.read_text(os.path.join(HERE, "patches", "P2a.json"))))
...
E.save_state(_st9)
print(f"        文件里 P2a+P2b 都在（sha256={_sha9[:16]}...），但 _state.json 的 installed 被清空")
